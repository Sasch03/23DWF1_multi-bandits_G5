...
const barData = [
    { arm: "Arm 1", efficiency: 0.8 },
    { arm: "Arm 2", efficiency: 0.6 },
    { arm: "Arm 3", efficiency: 0.75 },
]
...
export default function BanditResultsCharts() {
    return (
        <div className="flex flex-col md:flex-row gap-6 w-full">
            ...
            <ChartContainer config={chartConfig} className="flex-1 h-[250px] overflow-hidden">
                <BarChart width={300} height={250} data={barData}>
                    ...
                    <ChartTooltip content={<ChartTooltipContent labelKey="efficiency" nameKey="arm" />} />
                    <ChartLegend content={<ChartLegendContent nameKey="arm" />} />
                    <Bar dataKey="efficiency" fill="var(--chart-1)" radius={4} />
                </BarChart>
            </ChartContainer>
